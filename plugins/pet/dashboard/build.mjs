/**
 * Build script for the pet dashboard plugin.
 *
 ...
 * aliases, keyframes, and the deliberate global fixes in styles.css
 * (the ::selection / code repair — see its comment there).
 */
const PLUGIN_SCOPE = ".hermes-pet";
const KEEP_GLOBAL = [/^:root\b/, /^:host\b/, /^code\b/, /^::selection\b/];
