/**
 * Build script for the asset-view dashboard plugin.
 *
...
async function buildJs() {
  ...
  await esbuild.build({
    ...
    target: "es2022",
    jsx: "automatic",
    // Not minified — matches the readable style of the asset-view plugin bundle
 ...
 * (`main:has(.hermes-asset-view) …`, which PROMOTES the route-outlet wrapper —
 * it targets host elements by design and must keep winning).
 */
const PLUGIN_SCOPE = ".hermes-asset-view";
